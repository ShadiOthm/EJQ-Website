...
--
-- Host: localhost
-- Generation Time: Jun 29, 2017 at 09:10 PM
...
CREATE TABLE IF NOT EXISTS `demands_requests` (
  ...
  `visit_time_suggested` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `demands_tenders` (
  ...
  `title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8_unicode_ci,
  `chosen_bid_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=2 ;
...
--
-- Table structure for table `demands_tenders_bids`
--

DROP TABLE IF EXISTS `demands_tenders_bids`;
CREATE TABLE IF NOT EXISTS `demands_tenders_bids` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  `active` int(11) NOT NULL DEFAULT '1',
...
--
-- Table structure for table `demands_tenders_conditions`
--

DROP TABLE IF EXISTS `demands_tenders_conditions`;
CREATE TABLE IF NOT EXISTS `demands_tenders_conditions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  `active` int(11) NOT NULL DEFAULT '1',
...
(107, 9, 'User', 96, NULL, 100, 101),
(108, 9, 'User', 97, NULL, 102, 103);
...
(1, '2017-06-12 14:22:57', '2017-06-28 13:41:51', 1, 0, 1, 1, 85, 'Holly', NULL, 'ffff', NULL),
(2, '2017-06-12 14:29:39', '2017-06-28 11:30:38', 1, 0, 1, 1, 84, 'Helga', NULL, 'hehehehe', NULL),
(7, '2017-06-14 11:42:26', '2017-06-26 09:59:13', 1, 0, 1, 1, 95, 'Homer', NULL, 'hoomeoemeoe', NULL),
(8, '2017-06-16 16:35:49', '2017-06-16 17:45:07', 1, 0, 1, 1, 25, 'Bob', NULL, 'booboboboobo', NULL);
...
(3, '2017-06-12 14:24:11', '2017-06-18 20:07:06', 1, 0, 1, 1, 11, 'Pascoal', 'pascoal', NULL, NULL, NULL, 'papapapaa', NULL, NULL, NULL, NULL),
...
(9, '2017-06-16 16:36:37', '2017-06-17 20:12:53', 1, 0, 1, 2, 13, 'Nelson', 'nelson', NULL, NULL, NULL, 'nenenenene', NULL, NULL, NULL, NULL),
(10, '2017-06-16 17:59:18', '2017-06-17 19:31:13', 1, 0, 1, 1, 96, 'Juno', 'juno', NULL, 1, NULL, 'juno', NULL, NULL, NULL, NULL),
(11, '2017-06-17 19:40:37', '2017-06-17 19:47:56', 1, 0, 1, 1, 97, 'Joel', 'joel', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL),
(12, '2017-06-18 14:50:54', '2017-06-18 15:06:34', 1, 0, 1, 2, 54, 'Otto', 'otto', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(13, '2017-06-18 14:51:22', '2017-06-18 14:51:33', 1, 0, 1, 2, 55, 'Paul', 'paul', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(14, '2017-06-19 11:36:06', '2017-06-19 11:36:12', 1, 0, 1, 2, 86, 'Sam', 'sam', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(96, '2017-06-16 17:59:17', '2017-06-16 17:59:17', 1, 0, 1, 2, 'Juno', 'juno@easyjobquote.com', 'db5cf4a2470074d8b0681faff2a3291b32fb4f48'),
(97, '2017-06-17 19:40:37', '2017-06-17 19:40:37', 1, 0, 1, 2, 'Joel', 'joel@easyjobquote.com', 'db5cf4a2470074d8b0681faff2a3291b32fb4f48');
