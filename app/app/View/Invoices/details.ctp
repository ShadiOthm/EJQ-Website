        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item active"><a class="nav-link" data-toggle="tab" href="#billing" role="tab"><?php echo __('Invoice Details'); ?></a></li>
                </ul>

                <div class="tab-content">
                    <?php echo $this->Element('invoices/details'); ?>
           	</div>
            </div>
            <!-- /col 9 -->
        </div>
