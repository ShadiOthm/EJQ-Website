...
echo $this->Html->css('https://cdn.datatables.net/v/bs/dt-1.10.16/datatables.min.css');
echo $this->Html->css('bootstrap-datetimepicker.min.css?v=0.0.0');
 
echo $this->Html->script('respond.min.js?v=1.4.2'); 
echo $this->Html->script('jquery/jquery-1.12.0.min'); 
echo $this->Html->script('https://cdn.datatables.net/v/bs/dt-1.10.16/datatables.min.js'); 
echo $this->Html->script('https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.8.4/moment.min.js'); 
echo $this->Html->script('https://cdn.datatables.net/plug-ins/1.10.16/sorting/datetime-moment.js'); 
...
?>
    ...
    <?php echo $this->Html->css('bootstrap-toggle.min.css?v=0.0.0'); ?>
    <?php echo $this->Html->css('bootstrap-datetimepicker.min.css?v=0.0.0'); ?>
...
<?php
    ...
    array('escape' => false, 'rel' => 'nofollow')
        ...
        if (isset($tenderBreadcrumbNode)):
            echo $this->Html->link("&nbsp;&gt;&nbsp;" .
                    $tenderBreadcrumbNode['label'], 
                        array(
                            'controller' => $tenderBreadcrumbNode['controller'], 
                            'action' => $tenderBreadcrumbNode['action'], 
                            $tenderBreadcrumbNode['id'],
                            ),
                array('escape' => false, 'rel' => 'nofollow')
            );
            endif;        
...
?>
                ...
                <a id="<?php echo $action['id'];?>" class="btn btn-admin <?php echo (!empty($action['disabled']) ? 'disabled' : '');?>" href="<?php echo $action['href'];?>" role="button"><?php echo $action['label'];?></a>&nbsp;&nbsp;
<?php
endforeach;
?>            </div>
<?php
