        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item active"><a class="nav-link" data-toggle="tab" href="#dispatch_estimator" role="tab">
                    <?php echo __('Dispatch Project DEVELOPER1'); ?></a></li>
                </ul>
                
                <div class="tab-content">
                    <?php echo $this->Element('requests/dispatch_estimator'); ?>
                </div>
